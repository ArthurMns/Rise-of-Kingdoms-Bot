...
class BotConfig:
    def __init__(self, config={}):
        ...
        self.trainBarracksTrainingLevel = config.get(
            "trainBarracksTrainingLevel", TrainingAndUpgradeLevel.T1.value
        )
        self.trainBarracksUpgradeLevel = config.get(
            "trainBarracksUpgradeLevel", TrainingAndUpgradeLevel.T1.value
        )

        self.trainArcheryRangeTrainingLevel = config.get(
            "trainArcheryRangeTrainingLevel", TrainingAndUpgradeLevel.T1.value
        )
        self.trainArcheryRangeUpgradeLevel = config.get(
            "trainArcheryRangeUpgradeLevel", TrainingAndUpgradeLevel.T1.value
        )

        self.trainStableTrainingLevel = config.get(
            "trainStableTrainingLevel", TrainingAndUpgradeLevel.T1.value
        )
        self.trainStableUpgradeLevel = config.get(
            "trainArcheryRangeUpgradeLevel", TrainingAndUpgradeLevel.T1.value
        )

        self.trainSiegeWorkshopTrainingLevel = config.get(
            "trainSiegeWorkshopTrainingLevel", TrainingAndUpgradeLevel.T1.value
        )
        self.trainSiegeWorkshopUpgradeLevel = config.get(
            "trainSiegeWorkshopUpgradeLevel", TrainingAndUpgradeLevel.T1.value
        )
        ...
        self.enableGetInfoAllianceMember = config.get(
            "enableGetInfoAllianceMember", True
        )
        ...
        self.gatherResourceNoSecondaryCommander = config.get(
            "gatherResourceNoSecondaryCommander", True
        )
